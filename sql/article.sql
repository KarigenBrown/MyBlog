...
(
    ...
    `delete_flag` int(1)        DEFAULT '0' COMMENT '删除标志(0代表未删除,1代表已删除)',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 8
...
insert into `article`(`id`, `title`, `content`, `summary`, `category_id`, `thumbnail`, `is_top`, `status`, `view_count`,
                      `is_comment`, `create_by`, `create_time`, `update_by`, `update_time`, `delete_flag`)
